class View:
	...
	def no_account_msg(self):
		print('\nThere is currently no account in the database')
	...
	def get_fname_msg(self):
		return input('\nPlease enter yuour first name: ')

	def get_lname_msg(self):
		return input('\nPlease enter your last name: ')

	def add_success_msg(self, acc_num):
		print('\nYour accounthas been successfully created!'
			'\nYour account number is: {}'.format(acc_num))

	def del_success_msg(self):
		print('\nYour account has been successfully deleted')

	def depos_success_msg(self):
		print('\nSucessfully deposited ${} into {} acount'.format(amount, type))

	def withdr_sucess_msg(self, amount,type):
		print('\nSucessfully withdrew ${} from {} account'.format(amount,type))
	...
	def show_balance(self,amount):
		print('The current balance of the acount is {}'.format(amount))
